...
function testFunc(sender, text) {          // testFunction
    ...
    request({
        ...
        json: {
            recipient: { id: sender },
            message:{"success":"true","message":{"attachment":{"type":"template","payload":{"template_type":"generic","elements":[{"title":"pqr","sutitle":"test  2 description 1","image_url":"","buttons":{"type":"postback","title":"Order book","payload":"3"}},{"title":"hgfshd","sutitle":"nabdmsnfd","image_url":"","buttons":{"type":"postback","title":"Order book","payload":"5"}}]}}}}
        }
    }, function (error, response, body) {
        if (error) {
