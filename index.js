...
function testFunc(sender, text) {          // testFunction
    ...
    request({
        ...
        json: {
            recipient: { id: sender },
            message: { "attachment": { "type": "template", "payload": { "template_type": "generic", "elements": [{ "title": "pqr", "subtitle": "test  2 description 1", "image_url": "http://messengerdemo.parseapp.com/img/gearvr.png", "buttons": { "type": "postback", "title": "Order book", "payload": "3" } }, { "title": "hgfshd", "subtitle": "nabdmsnfd", "image_url": "http://messengerdemo.parseapp.com/img/gearvr.png", "buttons": { "type": "postback", "title": "Order book", "payload": "5" } }] } } }
        }
    }, function (error, response, body) {
        if (error) {
